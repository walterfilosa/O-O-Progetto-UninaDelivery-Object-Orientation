...
public class InfoSpedizione extends JFrame {
	...
	public InfoSpedizione(GestoreApplicazione ga) {
		setResizable(false);
		myGestore = ga;
		...
		lblRiepilogoSpedizione = new JLabel("INFO SPEDIZIONE");
	...
	public void aggiornaLista() {
		model.clear();
		for(Ordine o : myGestore.ListaSpedizioni.get(myGestore.gestioneSpedizioni.posizioneSpedizione).getOrdiniNellaSpedizione())
			model.addElement("ID Ordine: #" + o.getIdOrdine());
		listaOrdini.setModel(model);
	}
	
	public void aggiornaInfo() {
		lblDataDiConsegna.setText("Data: " + myGestore.ListaSpedizioni.get(myGestore.gestioneSpedizioni.posizioneSpedizione).getDataDiConsegna().getDayOfMonth() + "/" + myGestore.ListaSpedizioni.get(myGestore.gestioneSpedizioni.posizioneSpedizione).getDataDiConsegna().getMonthValue() + "/" + myGestore.ListaSpedizioni.get(myGestore.gestioneSpedizioni.posizioneSpedizione).getDataDiConsegna().getYear());
		lblCorriereAssegnato.setText("ID Corriere: #" + myGestore.ListaSpedizioni.get(myGestore.gestioneSpedizioni.posizioneSpedizione).getCorriereAssegnato().getID());
		lblMezzoAssegnato.setText("Targa Mezzo: #" + myGestore.ListaSpedizioni.get(myGestore.gestioneSpedizioni.posizioneSpedizione).getMezzoAssegnato().getTarga());
		lblPesoSpedizione.setText("Peso: " + myGestore.ListaSpedizioni.get(myGestore.gestioneSpedizioni.posizioneSpedizione).getPesoTotaleSpedizione() + " kg");
	}
}
