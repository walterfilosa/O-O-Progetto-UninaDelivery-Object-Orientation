...
public class InfoProdottoInOperatore extends JFrame {
	...
	public InfoProdottoInOperatore(GestoreApplicazione ga) {
		setResizable(false);
		myGestore = ga;
		...
		lblPrezzo.setBounds(588, 392, 230, 50);
	...
	{
		lblNomeProdotto.setText("Prodotto: " + myGestore.ListaProdotti.get(myGestore.gestioneProdotti.posizioneProdotto).getNome());
		lblIdProdotto.setText("ID prodotto: " + myGestore.ListaProdotti.get(myGestore.gestioneProdotti.posizioneProdotto).getIdProdotto());
		lblAziendaVenditrice.setText("Fornito da: " + myGestore.ListaProdotti.get(myGestore.gestioneProdotti.posizioneProdotto).getAziendaVenditrice());
		lblPeso.setText("Peso: " + myGestore.ListaProdotti.get(myGestore.gestioneProdotti.posizioneProdotto).getPeso() + " kg");
		aggiornaPrezzo();
		lblQuantita.setText("Quantità: " + myGestore.ListaProdotti.get(myGestore.gestioneProdotti.posizioneProdotto).getQuantitàDisponibile());
