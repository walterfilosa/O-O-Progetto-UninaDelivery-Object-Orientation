...
public class ModificaCorriere extends JFrame {
	...
	public ModificaCorriere(GestoreApplicazione ga) {
		setResizable(false);
		myGestore = ga;
		...
		btnSalva.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(controlliModifica())
				{
					...
					{
						if(myGestore.ListaCorrieri.indexOf(c) == myGestore.gestioneCorriereMezzi.posizioneCorriereSelezionato)
						{
							c.setNome(txtGetNome.getText());
							c.setCognome(txtGetCognome.getText());
							c.setCodiceFiscale(txtGetCodiceFiscale.getText());
							break;
						}
					}
